...
~~./src/utilstrencodings.h~~ - See the CPP file. [*Moved to ./src/util/strencodings.h in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).
...
./src/index/blockfilterindex.cpp - Block filter ([BIP 157](https://github.com/bitcoin/bips/blob/master/bip-0157.mediawiki)) indexing code. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/14121).

./src/index/blockfilterindex.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/14121).
...
./src/interfaces/chain.cpp - Inerface for giving wallets access to the blockchain state. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14437).

./src/interfaces/chain.h - See the CPP file. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14437).
...
**./src/node** - A directory meant for code that can be used to access node state (e.g., CChain, CBlockIndex, CCoinsView, CTxMemPool, etc.) from outside the node (e.g., inside the wallet code). [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14978).

./src/node/coin.cpp - Some basic coin-related functionality (e.g., looking up coins in the mempool and current chain UTXO set). [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/10973).

./src/node/coin.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/10973).

./src/node/psbt.cpp - PSBT code that needs to be callable by the wallet while accessing node classes (e.g., CCoinsViewCache). [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/node/psbt.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/node/README.md - README explaining the directory concept. Good overview of what is being accomplished here. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).
...
./src/policy/settings.cpp - Server policy settings (e.g., `incrementalRelayFee`, `dustRelayFee`, `nBytesPerSigOp`, and `flsBareMultisigStd`). [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/policy/settings.h - See the CPP file [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).
...
./src/qt/bitcoin.cpp - The kickoff and shutdown code for Bitcoin Core, using the GUI application’s main object (BitcoinApplication).

./src/qt/bitcoin.cpp - See the CPP file. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/11625).
...
./src/qt/macos\_appnap.cpp - Disable [App Nap](https://arstechnica.com/gadgets/2013/10/os-x-10-9/14/) in macOS. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/12783).

./src/qt/macos\_appnap.h - See the CPP file. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/12783).

./src/qt/main.cpp - Kicks off the GUI binary [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/11625).
...
./src/qt/qrimagewidget.cpp - QR image widget code. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15928).

./src/qt/qrimagewidget.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15928).
...
./src/qt/test/apptests.cpp - Contains *BitcoinApplication* and *RPCConsole* tests. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/11625).

./src/qt/test/apptests.h - See the CPP file. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/11625).
...
**./src/rpc** - General RPC functionality. Code isn't accessible from the GUI but is otherwise accessible outside the node library. *[Most files moved from ./src to ./src/rpc in 0.13](https://github.com/bitcoin/bitcoin/pull/7348).*
...
~~./src/rpc/mining.h~~ - See the CPP file. *[Added in 0.15](https://github.com/bitcoin/bitcoin/pull/10683) and [removed in 0.19](https://github.com/bitcoin/bitcoin/pull/15748)*.
...
~~./src/rpc/rawtransaction.h~~ - See the CPP file. *[Added in 0.17](https://github.com/bitcoin/bitcoin/pull/10579) and [moved to ./src/rpc/rawtransaction\_util.h in 0.19](https://github.com/bitcoin/bitcoin/pull/15638)*.

./src/rpc/rawtransaction\_util.cpp - Raw transaction RPC functionality (e.g., `ConstructTransaction` and `SignTransaction`). [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).
...
./src/test/blockfilter\_index\_tests.cpp - Tests related to BIP 157-associated block filter indexes. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/14121).
...
./src/test/main.cpp - Barebones test frontend. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15504).

~~./src/test/main\_tests.cpp~~ - [Unit tests related to money supplies.](https://github.com/bitcoin/bitcoin/pull/3768) [*Moved to ./src/test/validation\_tests.cpp in 0.19*](https://github.com/bitcoin/bitcoin/pull/15504).
...
./src/test/setup\_common.cpp - Some basic test setup code and other functionality (e.g., testing insecure random number generation). Mainly used to configure logging and chain parameters. [*Moved from ./src/test/test\_bitcoin.cpp in 0.19](https://github.com/bitcoin/bitcoin/pull/15788).

./src/test/setup\_common.h - See the CPP file. [*Moved from ./src/test/test\_bitcoin.h in 0.19](https://github.com/bitcoin/bitcoin/pull/15788).
...
~~./src/test/test\_bitcoin.cpp~~ - Some basic test setup code and other functionality (e.g., testing insecure random number generation). Mainly used to configure logging and chain parameters. [*Moved to ./src/test/setup\_common.cpp in 0.19*](https://github.com/bitcoin/bitcoin/pull/15788).

~~./src/test/test\_bitcoin.h~~ - See the CPP file. [*Moved to ./src/test/setup\_common.h in 0.19*](https://github.com/bitcoin/bitcoin/pull/15788).
...
./src/test/util.cpp - Test utility functionality. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15788).

./src/test/util.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15788).

./src/test/util\_tests.cpp - Unit tests for various utility-related files.

./src/test/util\_threadnames\_tests.cpp - Thread naming tests. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15849).
...
./src/test/validation\_tests.cpp - Unit tests related to money supplies. [*Moved from ./src/test/main\_tests.cpp in 0.19*](https://github.com/bitcoin/bitcoin/pull/15504).
...
./src/util/bytevectorhash.h - See the CPP file. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14074).

./src/util/error.cpp - Transaction error handling code. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/util/error.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/util/fees.cpp - Fee handling code. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/util/fees.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/util/memory.h - A replacement for [C++14's *make_unique()* function](https://en.cppreference.com/w/cpp/memory/unique_ptr/make_unique). [*Moved from ./src/utilmemory.h in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).

./src/util/moneystr.cpp - Various money utilities (e.g., *ParseMoney()*). [*Moved from ./src/utilmoneystr.cpp in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).

./src/util/moneystr.h - See the CPP file. [*Moved from ./src/utilmoneystr.h in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).

./src/util/rbf.cpp - RBF utility code. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/util/rbf.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/util/strencodings.cpp - String utilities (e.g., *DecodeBase32()*). [*Moved from ./src/utilstrencodings.cpp in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).

./src/util/strencodings.h - See the CPP file. [*Moved from ./src/utilstrencodings.h in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).

./src/util/system.cpp - Code related to the client/server environment. Used for argument handling, config file parsing, logging (pre-0.17), thread wrappers, global environment setup, Windows network setup, etc. [*Moved from ./src/util.cpp in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).

./src/util/system.h - See the CPP file. [*Moved from ./src/util.h in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).

./src/util/threadnames.cpp - Code for adding thread names, which are useful for debugging. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15849).

./src/util/threadnames.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15849).

./src/util/time.cpp - Time utilities (e.g., *SetMockTime()*). [*Moved from ./src/utiltime.cpp in 0.18*](https://github.com/bitcoin/bitcoin/pull/14555).
...
./src/util/validation.cpp - Code for converting validation state data into human-readable messages. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).

./src/util/validation.h - See the CPP file. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/15638).
...
./test/functional/feature\_shutdown.py - Tests *bitcoind* shutdown results. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14670).
...
./test/functional/interface\_rpc.py - Generic RPC interface tests. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14777).
...
./test/functional/p2p\_invalid\_messages.py - Tests P2P ability to process invalid messages and avoid things like DoS attacks. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14522).
...
./test/functional/rpc\_getblockfilter.py - Tests the *getblockfilter* RPC functionality. [*Added in 0.19*](https://github.com/bitcoin/bitcoin/pull/14121).
...
./test/functional/wallet\_import\_with\_label.py - Tests the ability of the wallet to maintain a watch-only address's label when the private key is import. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/13381).
...
./test/functional/data/invalid\_txs.py - Templates for constructing various incorrect transactions. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14457).
...
~~./test/lint/lint-python-shebang.sh~~ - A lint script that looks for missing Python [shebangs](https://en.wikipedia.org/wiki/Shebang_(Unix)). *[Moved from ./contrib/devtools in 0.17](https://github.com/bitcoin/bitcoin/pull/13281) and [moved to ./test/lint/lint-shebang.sh in 0.18](https://github.com/bitcoin/bitcoin/pull/14831)*.
...
./test/lint/lint-rpc-help.sh - Ensures that RPCHelpMan (internal function) is used to generate all RPC docs. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14726).

./test/lint/lint-shebang.sh - A lint script that looks for missing [shebangs](https://en.wikipedia.org/wiki/Shebang_(Unix)). *[Moved from ./contrib/devtools in 0.17](https://github.com/bitcoin/bitcoin/pull/13281) and [moved to ./test/lint/lint-shebang.sh in 0.18](https://github.com/bitcoin/bitcoin/pull/14831)*.
...
**./test/sanitizer\_suppressions** - Various code sanitizer files. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14521).

./test/sanitizer\_suppressions/lsan - [LSan](https://clang.llvm.org/docs/LeakSanitizer.html) file listing functions to ignore. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14794).

./test/sanitizer\_suppressions/tsan - [TSan](https://clang.llvm.org/docs/ThreadSanitizer.html) file listing functions to ignore. [*Added in 0.18*](https://github.com/bitcoin/bitcoin/pull/14764).

./test/sanitizer\_suppressions/ubsan -  [UBSan](https://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html) file listing functions to ignore. [*Moved from ./contrib/sanitizers-ubsan.suppressions in 0.18*](https://github.com/bitcoin/bitcoin/pull/14764).
